...
- (void)show:(BOOL)animated {
    ...
    if (animated) {
//        [self setSubviewTransform:CGAffineTransformMakeScale(1.3f, 1.3f) alpha:0.5f];//zkq old
        [self setSubviewTransform:CGAffineTransformMakeScale(1.3f, 1.3f) alpha:alphBackView];
