...
//        self.productView.frame=CGRectMake(0, 0, ScreenWidth, scrollivewHight);//金牛解锁
    ...
    if (self.adsArray && [self.adsArray count]>0) {
        ...
        scroller=[[EScrollerView alloc]
                  initWithFrameRect:CGRectMake(0, 0, ScreenWidth, productHeight)
                  ImageArray:[NSArray arrayWithObjects:@"IMG_1801.png",@"IMG_1802.png",@"IMG_1803.png", nil]
                  TitleArray:nil];
    ...
    if (indexPath.row==0) {
        ...
        for (NSInteger i=0; i<3; i++) {
            ...
            if (i==0) {
                ...
                button.frame=CGRectMake(ScreenWidth/4-30-20, 0, 60, 60);
                label.frame=CGRectMake(ScreenWidth/4-50-20, 60, 100, 30);

            }
            if (i==1) {
                button.frame=CGRectMake(ScreenWidth/2-30, 0, 60, 60);
                label.frame=CGRectMake(ScreenWidth/2-50, 60, 100, 30);

            }
            if (i==2) {
                
                button.frame=CGRectMake(ScreenWidth/2+ScreenWidth/4-30+20, 0, 60, 60);
                label.frame=CGRectMake(ScreenWidth/2+ScreenWidth/4-50+20, 60, 100, 30);
