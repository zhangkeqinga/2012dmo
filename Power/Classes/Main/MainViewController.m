...
- (void)loginSuccess:(BOOL)isLogin {
    ...
    // 添加子控制器
    [self addChildViewControllerWithTitle:NSLocalizedString(@"menu_1", nil)
                           storyboardName:@"AppointDoctor"
                                     icon:@"product_gray"
                                  selIcon:@"product_gray"];
    
    [self addChildViewControllerWithTitle:NSLocalizedString(@"menu_2", nil)
                           storyboardName:@"StarDoctor"
                                     icon:@"product_list_gray"
                                  selIcon:@"product_list_gray"];
    
    [self addChildViewControllerWithTitle:NSLocalizedString(@"menu_3", nil)
    ...
    if (isLogin) { //登陆成功
        ...
        [self addChildViewControllerWithTitle:NSLocalizedString(@"menu_4", nil)
