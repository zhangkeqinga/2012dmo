...
//        CGSize dims = [self.labelText sizeWithFont:self.labelFont];
        ...
        NSDictionary *attribute = [NSDictionary dictionaryWithObjectsAndKeys:self.labelFont, NSFontAttributeName, nil];
        
        CGSize dims = [self.labelText sizeWithAttributes:attribute];
...
//            dims = [self.detailsLabelText sizeWithFont:self.detailsLabelFont];
            ...
            CGSize dims = [self.detailsLabelText sizeWithAttributes:attribute];
